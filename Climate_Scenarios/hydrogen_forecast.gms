...
*          INDUSTRIAL THERMAL
*--------------------------------
SpecifiedAnnualDemand('GERMANY','IH_ACC_H2','2030') = 25*3.6;
SpecifiedAnnualDemand('GERMANY','IH_ACC_H2','2035') = 36*3.6;
SpecifiedAnnualDemand('GERMANY','IH_ACC_H2','2040') = 59*3.6;
SpecifiedAnnualDemand('GERMANY','IH_ACC_H2','2045') = 85*3.6;
...
*           POWER SECTOR
*--------------------------------
SpecifiedAnnualDemand("GERMANY","ELC_ACC_H2","2030") = 1*3.6;
SpecifiedAnnualDemand("GERMANY","ELC_ACC_H2","2035") = 4*3.6;
SpecifiedAnnualDemand("GERMANY","ELC_ACC_H2","2040") = 21*3.6;
SpecifiedAnnualDemand("GERMANY","ELC_ACC_H2","2045") = 71*3.6;
