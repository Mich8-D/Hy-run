...
#whilst renewables_data.gms has issues, define FixedCost and VariableCost parameters here:
#These are 2023 values, require extrapolated data for subsequent years
Parameter FixedCost(r,t,y) /
GERMANY.BATTERY.(2024*2050) = 11.75
/;

Parameter VariableCost(r,t,m,y) /
GERMANY.BATTERY.1.(2024*2050) = 1.75
/;

OperationalLife(r,'BATTERY') = 15;
EmissionActivityRatio(r,'BATTERY','CO2',m,y) = 0;
CapacityFactor(r,'BATTERY',l,y) = 0.228; #load factor 2000/ 8760 hours in a year